//! Misc EFI odds and ends the system needs to boot
...
///Convert memory sizes to memory pages (being 4096 bytes each)
pub inline fn efi_size_to_pages(value: anytype) @TypeOf(value) {
